...
class DenseMotionNetwork(nn.Module):
    ...
    def __init__(self, block_expansion=64, num_blocks=5, max_features=1024, num_tps=10, num_channels=3, 
                 scale_factor=0.25, bg = True, multi_mask = True, kp_variance=0.01):
        super(DenseMotionNetwork, self).__init__()

        if scale_factor != 1: # True
    ...
    # def forward(self, source_image, kp_driving, kp_source, dropout_flag=False, dropout_p = 0):
    def forward(self, source_image, kp_driving, kp_source):
        # print("DenseMotionNetwork scale_factor: ", self.scale_factor, "-"*8)
